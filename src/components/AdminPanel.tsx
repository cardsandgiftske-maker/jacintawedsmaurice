...
export default function AdminPanel() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (
      lower === 'jacintamaurice2026' ||
      lower === 'jacintamaurice' ||
      lower === 'jacinta' ||
      lower === 'maurice' ||
      lower === '2026'
    ) {
    ...
    <>
      ...
      <div className="py-10 bg-stone-900 flex justify-center border-t border-stone-950 text-stone-100 font-sans text-xs select-none">
        <div className="flex flex-col items-center gap-2">
          <p className="text-stone-300">© 2026 Jacinta &amp; Maurice. All rights reserved.</p>
          <button
          ...
          >
            <Shield className="w-3.5 h-3.5 text-dustyrose-400" />
            <span>Couple Admin Portal</span>
            <span className="text-[9px] bg-stone-950 text-dustyrose-300 border border-dustyrose-800/40 px-1.5 py-0.5 rounded-full font-mono text-[8px] font-bold tracking-wider uppercase">Secured</span>
          </button>
        </div>
      </div>
            ...
            <div className="bg-white border border-stone-200 rounded-3xl w-full max-w-4xl shadow-2xl overflow-hidden relative flex flex-col my-8 max-h-[90vh]">
              ...
              <div className="border-b border-stone-100 p-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-dustyrose-50 flex items-center justify-center text-dustyrose-700">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {isFirebaseConfigured ? (
                        <span className="flex items-center gap-1 text-[8px] text-sage-800 bg-sage-50 border border-sage-200/50 px-1.5 py-0.5 rounded font-sans font-bold uppercase tracking-wider">
                          Cloud Live
                        </span>
                      ) : (
                    ...
                    <p className="text-xs text-stone-500 font-sans">Jacinta &amp; Maurice Wedding RSVP Dashboard</p>
                  </div>
                </div>
                <button
              ...
              {!isAuthenticated ? (
                <div className="p-12 flex flex-col items-center justify-center text-center max-w-sm mx-auto space-y-6">
                  <div className="w-16 h-16 rounded-full bg-dustyrose-50 flex items-center justify-center text-dustyrose-700 animate-pulse">
                  ...
                  <form onSubmit={handleLogin} className="w-full space-y-4">
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-stone-50 border border-stone-200 focus:border-dustyrose-700 rounded-xl pl-4 pr-11 py-3 text-sm text-stone-800 outline-none transition-colors text-center"
                      />
                      <button
                        type="button"
                    ...
                    <button
                      type="submit"
                      className="w-full py-3 bg-dustyrose-700 hover:bg-dustyrose-800 text-white font-sans font-bold uppercase tracking-wider text-xs rounded-xl shadow-md transition-all cursor-pointer"
                    >
                      Authenticate Access
                    </button>
                  </form>
                ...
                <div className="p-6 overflow-y-auto space-y-6 flex-1 flex flex-col">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                    ...
                    <div className="bg-[#FCFAF7] border border-stone-200 p-3.5 rounded-2xl flex items-center gap-3 shadow-sm">
                      <div className="w-9 h-9 rounded-xl bg-dustyrose-50 text-dustyrose-700 flex items-center justify-center shrink-0">
                    ...
                    {/* Stat 2 */}
                    <div className="bg-[#FCFAF7] border border-stone-200 p-3.5 rounded-2xl flex items-center gap-3 shadow-sm">
                      <div className="w-9 h-9 rounded-xl bg-sage-50 text-sage-800 flex items-center justify-center shrink-0">
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-2">
                    ...
                    <div className="flex flex-wrap items-center gap-3 w-full md:w-auto flex-1">
                      ...
                      <div className="relative flex-1 max-w-sm min-w-[200px]">
                        ...
                        <input
                          ...
                          className="w-full bg-stone-50 border border-stone-200 focus:border-dustyrose-700 rounded-xl pl-10 pr-4 py-2 text-xs text-stone-800 outline-none transition-colors"
                        />
                      </div>
                      ...
                      <div className="inline-flex bg-stone-50 border border-stone-200 rounded-lg p-1 text-xs">
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-md font-medium transition-all cursor-pointer ${
                            attendanceFilter === 'all' ? 'bg-dustyrose-700 text-white font-bold' : 'text-stone-550 hover:text-stone-900'
                          }`}
                        >
                          All ({guests.length})
                        </button>
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-md font-medium transition-all cursor-pointer ${
                            attendanceFilter === 'yes' ? 'bg-dustyrose-700 text-white font-bold' : 'text-stone-550 hover:text-stone-900'
                          }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-md font-medium transition-all cursor-pointer ${
                            attendanceFilter === 'no' ? 'bg-dustyrose-700 text-white font-bold' : 'text-stone-550 hover:text-stone-900'
                          }`}
                        >
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto justify-end">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-dustyrose-700 hover:bg-dustyrose-800 text-white font-bold rounded-xl text-xs flex items-center gap-2 cursor-pointer shadow disabled:opacity-50"
                      >
                        ...
                        {filteredGuests.length === 0 ? (
                          ...
                          filteredGuests.map((guest) => (
                            <tr key={guest.id} className="border-b border-stone-100 hover:bg-stone-50 transition-colors">
                              ...
                              <td className="p-4 text-center font-mono font-bold text-dustyrose-700 tracking-wider">
                                {guest.eCardCode}
                              </td>
